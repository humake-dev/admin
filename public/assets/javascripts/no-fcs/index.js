      ...
      if(data.result=='success') {
        ...
        if(data.total) {
          $.each(data.list,function(index,value){
            ...
            $("#employee_user_table tbody").append('<tr><td>'+number+'</td><td><a href="/view/'+value['id']+'" target="_blank">'+value['name']+' / '+phone+'</a></td><td class="text-right">'+e_status+'</td><td class="text-right">'+period_month+'</td><td>'+transaction_date+'</td><td><label style="display:block"><input type="checkbox" name="user_id[]" value="'+value['id']+'"'+checked+'></label></td></tr>');
          });
