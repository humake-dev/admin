...
<?php echo form_open('/rent-sws/disable/'.$data['content']['order_id'], array('id' => 'rent_expire_log_delete_form')); ?>
<input type="hidden" name="return_url" value="/home/rents/<?php echo $data['content']['user_id']; ?>" />
...
<?php else: ?>
  <div class="container">
    <div class="row">
      <div class="col-12">
      <?php echo form_open('/rent-sws/disable/'.$data['content']['id'], array('class' => '')); ?>
      <input type="hidden" name="return_url" value="/home/rent-sws/<?php echo $data['content']['user_id']; ?>" />
<?php endif; ?>
...
<article class="col-12">
  <h3><?php echo _('Rent Sws Info'); ?></h3>
  <div class="card">
    <div class="card-body">
      <div class="row">
...
<div class="modal-footer">
  <?php echo form_submit('', _('Rent Disable'), array('class' => 'btn btn-primary btn-block')); ?>
</div>
<?php echo form_close(); ?>
<?php else: ?>
        <?php echo form_submit('', _('Rent Disable'), array('class' => 'btn btn-primary btn-block btn-lg')); ?>
      <?php echo form_close(); ?>
    </div>
  </div>
</div>
