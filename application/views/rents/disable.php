...
<?php echo form_open('/rents/disable/'.$data['content']['order_id'], array('id' => 'rent_expire_log_delete_form')); ?>
...
<?php else: ?>
  <div class="container">
    <div class="row">
      <div class="col-12">
      <?php echo form_open('/rents/disable/'.$data['content']['id'], array('class' => '')); ?>
      <input type="hidden" name="return_url" value="/home/rents/<?php echo $data['content']['user_id']; ?>" />
<?php endif; ?>
