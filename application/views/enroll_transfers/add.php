...
?>
                ...
                <?php if(!empty($data['same_rent']) or !empty($data['same_rent_sw'])): ?>
                <article id="same-rent" class="col-12">
                    <h3><?php echo _('Same Transfer'); ?></h3>
                    <div class="card">
                        <div class="card-body">
                    <?php if(!empty($data['same_rent'])): ?>
                        <div class="row">
            <div class="col-12 col-lg-6 form-group">
                <label><?php echo form_input(array('type' => 'checkbox', 'name' => 'same_rent', 'value' => $data['same_rent']['order_id'], 'checked'=>1)); ?><?php echo $data['same_rent']['product_name']?></label>
            </div>
            <div class="col-12 form-group to_other_branch" style="display:none">
                                    <label><?php echo sprintf(_('Match %s'), $data['product_name']) ?></label>
                                    <?php
                                    $attr = array('id' => 'new_product_rent', 'class' => 'form-control', 'style' => 'margin-bottom:5px', 'disabled' => 'disabled');
                                    ...
                                    echo form_dropdown('same_rent_product_id', $options, $select, $attr);
                                    ?>
                                </div>
                        </div>
            <?php endif ?>
            <?php if(!empty($data['same_rent_sw'])): ?>
                <div class="row">
            <div class="col-12 col-lg-6 form-group">
                <label><?php echo form_input(array('type' => 'checkbox', 'name' => 'same_rent_sw', 'value' =>  $data['same_rent_sw']['order_id'], 'checked'=>1)); ?><?php echo $data['same_rent_sw']['product_name'] ?></label>
            </div>
            <div class="col-12 form-group to_other_branch" style="display:none">
                                    <label><?php echo sprintf(_('Match %s'), $data['product_name']) ?></label>
                                    <?php
                                    $attr = array('id' => 'new_product_rent_sw', 'class' => 'form-control', 'style' => 'margin-bottom:5px', 'disabled' => 'disabled');
                                    ...
                                    echo form_dropdown('same_rent_sw_product_id', $options, $select, $attr);
                                    ?>
                                </div>
               </div>
            <?php endif ?>
