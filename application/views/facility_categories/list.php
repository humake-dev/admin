<div class="col-12 col-xxl-9 list">
  <div class="row">
    <div class="col-12">
      <h2 class="float-left"><?php echo _('Facility Category List'); ?></h2>
      <div class="float-right">
        <p class="summary">
          <span id="list_count" style="display:none"><?php echo $data['total']; ?></span>
          <?php echo sprintf(_('There Are %d Facility Category'), $data['total']); ?>
        </p>
    	</div>
    </div>
      ...
      <table id="counsel_list" class="table table-bordered table-hover">
        ...
        <tbody>
          ...
          <tr<?php if (isset($data['content'])): ?><?php if ($data['content']['id'] == $value['id']): ?> class="table-primary"<?php endif; ?><?php endif; ?>>
            ...
            <td><?php echo anchor('facility-categories/view/'.$value['id'], $value['title']); ?></td>
            <td>
            ...
            <td>
              <?php echo anchor('facility-categories/edit/'.$value['id'], _('Edit'), array('class' => 'btn btn-secondary')); ?>
              <?php echo anchor('facility-categories/delete/'.$value['id'], _('Delete'), array('class' => 'btn btn-danger btn-delete-confirm')); ?>
            </td>
          </tr>
          <?php endforeach; ?>
          <?php else: ?>
    ...
    <div class="col-12">
      <?php echo anchor('facility-categories/add', _('Add'), array('class' => 'btn btn-primary hidden-xxl')); ?>
    </div>
  </div>
</div>
