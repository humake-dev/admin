<div id="users" class="container">
  <div class="row">
    ...
    <div class="col-12 col-lg-8 col-xxl-9 user_sub">
      ...
      <div class="row">
        <div class="col-12 col-xl-6">
          <article class="card">
            ...
            <div class="card-body">
            <input type="hidden" id="user_attendance_count" value="<?php echo $data['list']['total']; ?>" />
            <table id="user_attendance_list" class="table">
              ...
              <tr>
                ...
                <td class="text-center">
                  <?php echo anchor('/employee-attendances/delete/'.$value['id'], _('Delete'), array('class' => 'btn btn-danger btn-delete-confirm')); ?>
                </td>
              </tr>
              <?php endforeach; ?>
              <?php else: ?>
      ...
      <div class="col-12 col-xl-6">
        <article class="card">
          <h3 class="card-header"><?php echo _('Select attendance date'); ?> / <?php echo _('Watch attendance'); ?></h3>
          <div id="attendance_calendar" data-date-end-date="0d"></div>
        </article>
          <article class="card">
            <h3 class="card-header"><?php echo _('Attendance Add'); ?></h3>
            <?php echo form_open('employee-attendances/add', array('id' => 'employee_attendance_form', 'class' => 'card-body'), array('employee_id' => $data['content']['id'])); ?>
              <div class="row">
                <div class="col-12">
              <div class="form-group">
                <div class="input-group">
                  <input type="text" name="date" id="employee_attendance_date" value="<?php echo set_value('date', $search_data['date']); ?>" class="form-control" />
