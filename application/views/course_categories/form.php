<?php
  if (empty($data['content'])) {
      $form_url='/course-categories/add';
  } else {
      $form_url='/course-categories/edit/'.$data['content']['id'];
  }
?>
<div class="card">
  <?php echo form_open($form_url, array('id'=>'course_category_add_form','class'=>'card-body')) ?>
  <div class="form-row">
