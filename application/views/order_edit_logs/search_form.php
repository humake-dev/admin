      ...
      <?php echo form_open('', array('method'=>'get','class'=>'card-body')) ?>
        <div class="row">
            ...
            <div class="col-12 col-lg-4 form-group">
              <label><?php echo _('Field') ?></label>
              <?php
              
                $field_options=array(''=>_('All'),'transaction_date' => _('Transaction Date'),'start_date' => _('Start Date'),'end_date'=>_('End Date'),'quantity'=>_('Quantity'));
                $field_select=set_value('field', '');
                
                echo form_dropdown('field', $field_options, $field_select, array('id'=>'oel_field','class'=>'form-control'));              
              ?>
            </div>
            <div class="col-12 col-lg-4 form-group">
