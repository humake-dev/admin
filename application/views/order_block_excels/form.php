<?php
  ...
  if (empty($params)) {
      echo form_open('/order-block-excels/add');
  } else {
      echo form_open('/order-block-excels/add'.$params);
  }
...
<div id="select_not_user_layer" class="form-group">
  <label><?php echo _('Select User'); ?></label>
  <div class="users_input" style="display:block">
...
<div class="form-group">
<label for="ob-period"><?php echo _('Period'); ?></labeL>
<?php
