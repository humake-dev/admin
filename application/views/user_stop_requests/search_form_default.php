<?php echo form_open('', ['method' => 'get', 'id' => 'search_counsel_default_form', 'class' => 'search_form col-12']); ?>
  <div class="form-row">
    ...
    <div class="col-12 col-lg-3 form-group">
      <label for="search_branch"><?php echo _('Branch'); ?></label>
      <?php
                  ...
                  echo form_dropdown('branch_id', $options, $select, array('id' => 'search_branch', 'class' => 'form-control'));
                ?>
      </div>
      <?php endif ?>
      <div class="col-12 col-lg-3 form-group">
      ...
      ?>
      <div class="input-group-prepend select-fc no-search<?php if($this->session->userdata('center_id')): ?> search-branch<?php endif ?>" style="width:180px;cursor:pointer">
      <?php
        echo form_input([
          'name' => 'manager_name',
          'id' => 's_employee',
  ...
  <div class="col-6 col-lg-3 form-group">
      <label for="c_complete"><?php echo _('Result'); ?></label>
      <?php
    ...
    <div id="default_period_form" class="form-group">
          <label for="start_date"><?php echo _('Period'); ?></label>
          <div class="form-row">
