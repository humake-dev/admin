<div class="col-12 col-xxl-9 list">
  <div class="row">
  <div class="col-12">
      <h2 class="float-left"><?php echo _('Exercise Category List') ?></h2>
      <div class="float-right">      
        <p class="summary">
          <span id="list_count" style="display:none"><?php echo $data['total'] ?></span>
          <?php echo sprintf(_('There Are %d Exercise Category'),$data['total']) ?>
        </p>
      </div>
    </div>
      ...
      <table id="training_prepare_list" class="table table-bordered table-hover">
        ...
        <thead class="thead-default">
          <tr>
            ...
            <th style="width:136px"><?php echo _('Image') ?></th>
        ...
        <tbody>
          ...
          ?>
            <tr<?php if (isset($data['content'])): ?><?php if ($data['content']['id']==$value['id']): ?> class="table-primary"<?php endif ?><?php endif ?>>
              <td><?php echo anchor('exercise-categories/view/'.$value['id'], $value['title']) ?></td>
              <td>
              ...
              <td class="d-none d-lg-table-cell text-center">
                <?php echo anchor('exercise-categories/edit/'.$value['id'].$page_param, _('Edit'), array('class'=>'btn btn-secondary')) ?>
                <?php echo anchor('exercise-categories/delete/'.$value['id'], _('Delete'), array('class'=>'btn btn-danger btn-delete-confirm')) ?>
              </td>
            </tr>
          <?php endforeach ?>
          <?php else: ?>
    ...
    <div class="col-12">
      <?php echo anchor('exercise-categories/add', _('Add'), array('class'=>'btn btn-primary hidden-xxl')) ?>
    </div>
  </div>
</div>
