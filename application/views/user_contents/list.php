<table id="user_contents_list" class="table table-striped table-hover">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center"><?php echo anchor('user-contents/view/'.$value['id'], _('Show Content'), array('class' => 'btn btn-secondary btn-modal')); ?></td>
            <td><?php echo get_dt_format($value['created_at'], $search_data['timezone']); ?></td>
            <td class="text-center"><?php echo anchor('user-contents/delete/'.$value['id'], _('Delete'), array('class' => 'btn btn-danger')); ?></td>
        </tr>
        <?php endforeach; ?>
        <?php endif; ?>
    </tbody>
