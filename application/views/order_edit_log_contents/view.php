...
<?php echo form_open('/order-edit-log-contents/edit/' . $data['content']['id']); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="modal-footer">
                <!-- <?php echo anchor('/order-edit-log-contents/delete/' . $data['content']['id'], _('Delete'), array('class' => 'btn btn-danger content-delete')); ?>
