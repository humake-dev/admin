...
<?php echo form_open($this->router->fetch_class() . '/edit/' . $data['content']['id']); ?>
    <div class="modal-header">
        <h2 class="modal-title"><?php echo _('Answer'); ?></h2>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="modal-footer">
                <?php echo anchor($this->router->fetch_class() . '/delete/' . $data['content']['id'], _('Delete'), array('class' => 'btn btn-danger content-delete')); ?>
