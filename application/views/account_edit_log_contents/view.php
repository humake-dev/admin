...
<?php echo form_open('/account-edit-log-contents/edit/' . $data['content']['id']); ?>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="modal-footer">
                <!-- <?php echo anchor('/account-edit-log-contents/delete/' . $data['content']['id'], _('Delete'), array('class' => 'btn btn-danger content-delete')); ?>
