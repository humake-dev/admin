<div id="users" class="container">
    <div class="row">
        ...
        include __DIR__ . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'home' . DIRECTORY_SEPARATOR . 'aside.php';
        $params = '';
        if ($this->input->get()) {
            $p_index = 0;
        ...
        <div class="col-12 col-lg-7 col-xl-8 col-xxl-9 user_sub">
            ...
            <section class="row">
                <div class="col-12">
                    <h2 class="di_title"><?php echo _('Basic member information') ?></h2>
                                ...
                                <?php if (empty($search_data['search_type'])): ?>
                                    <p><?php echo _('Register first') ?>
                                        <?php if ($this->Acl->has_permission('users', 'write')): ?>
                                            <?php echo anchor('users/add', '회원등록', array('class' => 'btn btn-secondary')) ?>
                                        <?php endif ?>
                                    </p>
                                <?php else: ?>
                    ...
                    <?php else: ?>
                        <div class="form-group" style="text-align:right">
                            <?php echo anchor('/view/' . $data['content']['id'] . $params, _('View Mode'), array('class' => 'btn btn-secondary')) ?>
                        </div>
