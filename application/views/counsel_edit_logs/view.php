<div id="view-notice" class="container">
  <div class="row">
    <div class="col-12">
      <div class="card">
        <h3 class="card-header"><?php echo $data['content']['created_at'] ?>에 수정한 <?php echo $data['content']['title'] ?>의 변경사항</h3>
        <div class="card-body">
          <div>
          ...
          <table class="table table-striped table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo display_edit_counsel_log_value($value['field'],$value['origin'],$search_data['timezone']) ?></td>
                <td><?php echo display_edit_counsel_log_value($value['field'],$value['change'],$search_data['timezone']) ?></td>
              </tr>
              <?php endforeach ?>
              <?php endif ?>
            </tbody>
